	...
	protected void onHandleIntent(Intent intent) {
		...
		if (!extras.isEmpty()) {
			if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR.equals(messageType)) {
				...
				// if (!prefs.getString("CURRENT_ACTIVE",
				// "").equals(extras.getString("fromu"))) {
				String sptag = extras.getString("fromu") + "msgs";
				SharedPreferences.Editor edit = prefs.edit();
				edit.putString(sptag, prefs.getString(sptag, "") + (prefs.getString(sptag, "").length() > 0 ? separator : "") + "<b>" + extras.getString("name") + " : </b>" + extras.getString("msg"));
				edit.commit();
				sendNotification(extras.getString("msg"), extras.getString("fromu"), extras.getString("name"));
				// }
				Log.i("TAG", "Received: " + extras.getString("msg") + " : " + prefs.getString("CURRENT_ACTIVE", ""));
			}
		}
